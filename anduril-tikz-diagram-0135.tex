...
\node (Candle from OFF)[
    extendedsimpleconfig-mode,
    above right=0.45cm and 1.2cm of
...
{ [on background layer]
    \node (Voltage Config from Batt Check)[
        advancedtable,
        above right=0.4cm and 1.4cm of
...
]
{
    ...
    Off \char"2192{} Low\default{} \char"2192{}
    High \char"2192{} Blinking
};
...
]
{
    ...
    Off \char"2192{} Low \char"2192{}
    High \char"2192{} Blinking\default{}
};
