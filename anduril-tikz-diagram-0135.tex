...
% for infotext for Extended Simple UI and Advanced UI
...
% (Unicode character White Left-Pointing Triangle)
...
\draw (Lockout to OFF right arrow.south west) edge[
    ->,
    anyline,
    line cap=round
]
...
\draw (OFF right to Lockout arrow.south east) edge[
    ->,
    anyline,
    line cap=round
]
...
]
{
    ...
    \normalsize Diagram Release 0135-42\\[1.5ex]
    Diagram Repository:\\
