...
]
{
    \begin{tabular}{m{0.35cm} l}
	    ...
	    \multicolumn{2}{l}{
            \thead{\firstlinetable{Channel mode}
            \onelinetable{sequence}}
        }\\
 		{1} & \makecell{
		    Channel 1
		}\\
...
]
{
    \begin{tabular}{m{0.35cm} l}
	    ...
	    \multicolumn{2}{l}{
            \thead{\firstlinetable{Hardware-specific; may not}
            \onelinetable{be present on all lights}}
        }
    \end{tabular}
};
...
]
{
    ...
    \normalsize Diagram Release 0135-05\\[2.0ex]
    Diagram Repository:\\
