% Diagram for the Anduril 2 UI, model number 0135
...
\usepackage[skins]{tcolorbox} % for colored and framed text boxes
...
\node (Ramp Style Stepped)[
    below left=0.05cm and 0.3cm+0.02cm of Ramp.south east, % +0.02cm
...
\node (Toggle Ramp Style from ON)[
    extendedsimpleconfig,
    below=0.75cm of Ramp.south,
    anchor=north,
    align=center
]
{\oneline{Toggle Ramp Style}};
\node (Toggle Ramp Style extra node ON)[
    on-extra,
    below right=0.75cm and 0.1cm of Toggle Ramp Style from ON.west,
    anchor=center
]
{ON};
\node (Toggle Ramp Style extra node 6C)[
    extendedsimplebutton,
    below=0.75cm of Toggle Ramp Style from ON.center,
    anchor=center,
    label={
...
{
    \firstline{Police Strobe}
    Channels 1 and 2 % Red and blue aux
};

\draw (Police Strobe from Tactical Strobe.north) edge[
    ->,
    extendedsimpleline-mode,
    out=90,
    in=270,
    looseness=1
]
node[
    extendedsimplebutton-mode,
    pos=0.4
]
...
\node (Candle from OFF)[
    extendedsimpleconfig-mode,
    above right=0.65cm and 1.2cm of Lightning Storm from Police Strobe.east,
    anchor=west
]
{\oneline{Candle\default{}}};
...
\node (Candle Timer)[
    extendedsimpleconfig,
    above left=0.47cm and 1cm of Candle from OFF.west,
    anchor=east
]
{
...
]
{
    ...
    1H = Tactical Slot 1 (high); 130\default{}\\
    2H = Tactical Slot 2 (low); 30\default{}\\
    3H = Tactical Slot 3 (strobe); Police\default{}
};
...
\node (Voltage Config from Batt Check)[
    advancedtable,
    above right=0.4cm and 1.5cm of Tactical Mode Config.south east,
    anchor=south west
]
{
    \begin{tabular}{m{0.35cm} l}
        ...
        {2} & \makecell{
            \voltageboxred{Po\hspace{-0.01cm}%
            \vphantom{Post-Off Display}}%
            \voltagebox[yellow]{\hspace{-0.01cm}st-\hspace{-0.01cm}%
            \vphantom{Post-Off Display}}%
            \voltagebox[green]{\hspace{-0.01cm}Off\hspace{-0.01cm}%
            \vphantom{Post-Off Display}}%
            \voltagebox[cyan]{\hspace{-0.01cm}\nobreakspace
            Di\hspace{-0.01cm}%
            \vphantom{Post-Off Display}}%
            \voltagebox[blue]{\hspace{-0.01cm}spl\hspace{-0.01cm}%
            \vphantom{Post-Off Display}}%
            \voltageboxpurple{\hspace{-0.01cm}ay%
            \vphantom{Post-Off Display}}
        }\\
        {} & \makecell{
            0C = Disable\\
            nC = n seconds; 4s\default{}
        }
    \end{tabular}
};
...
\node (Temp Check Thermal Config)[
    advancedtable,
    above right=0.2cm and 0.95cm of Temp Check from Batt Check.north east,
    anchor=north west
]
{
    \begin{tabular}{m{0.35cm} l}
...
\node (Beacon Speed)[
    advancedconfig,
    below right=0.68cm and 0.95cm of Beacon from Temp Check.east,
    anchor=west
]
{
...
]
{
    \begin{tabular}{m{0.35cm} l}
        ...
        {1} & \makecell{
            Floor: nC = n of 150; 10\default{}
        }\\
        {2} & \makecell{
            Ceiling: nC = 151 \char"2212{} n; 130\default{}
        }\\
        {3} & \makecell{
            Speed\inherited{}: 1C\default{} (full speed)\\
            to 4C (quarter speed)
        }\\
        \multicolumn{2}{l}{
        ...
        {3} & \makecell{
            Step count: 1\textendash{}150C; 7\default{}
        }
    \end{tabular}
};
...
]
{
    \begin{tabular}{m{0.35cm} l}
        ...
        {1} & \makecell{
            Disable manual memory\inherited{}\default{}
        }\\
        {} & \makecell{
            1+C
        }\\
        ...
        \multicolumn{2}{l}{
            \makecell{Automatic: Last-ramped\default{}\\
            Manual: User's saved\\
...
]
{
    \begin{tabular}{m{0.35cm} l}
        ...
        {3} & \makecell{
            Step count: 1\textendash{}150C; 5\default{}
        }\\
        {4} & \makecell{
        ...
        {} & \makecell{
            0C = Ceiling only, no turbo\default{}\\
            1C = Turbo\\
            2C = Ceiling, or turbo if\\
            ramped up to ceiling first
        }
...
{10H} (Simple UI Config from OFF.300);
...
{
    \firstline{OFF Aux LED Color}
    Red \char"2192{} Yellow \char"2192{} Green \char"2192{}
    Cyan \char"2192{}\\
    Blue \char"2192{} Purple \char"2192{} White \char"2192{}\\
    Disco \char"2192{} Rainbow\default{} \char"2192{}
    \voltageboxred{V\hspace{-0.01cm}%
    \vphantom{Voltage}}%
    \voltagebox[yellow]{\hspace{-0.01cm}o\hspace{-0.01cm}%
    \vphantom{Voltage}}%
    \voltagebox[green]{\hspace{-0.01cm}lt\hspace{-0.01cm}%
    \vphantom{Voltage}}%
    \voltagebox[cyan]{\hspace{-0.01cm}a\hspace{-0.01cm}%
    \vphantom{Voltage}}%
    \voltagebox[blue]{\hspace{-0.01cm}g\hspace{-0.01cm}%
    \vphantom{Voltage}}%
    \voltageboxpurple{\hspace{-0.01cm}e%
    \vphantom{Voltage}}
};
...
{
    \firstline{OFF Aux LED Pattern}
    Off \char"2192{} Low\default{} \char"2192{} High \char"2192{} Blinking
};
...
{
    \firstline{Lockout Aux LED Color}
    Red \char"2192{} Yellow \char"2192{} Green \char"2192{}
    Cyan \char"2192{}\\
    Blue \char"2192{} Purple \char"2192{} White \char"2192{}\\
...
{
    \firstline{Lockout Aux LED Pattern}
    Off \char"2192{} Low \char"2192{} High \char"2192{} Blinking\default{}
};
...
{\oneline{Extended Simple UI\default{}}};
...
{
    \Huge\textbf{Andúril 2 UI}\\[2.0ex]
    \modelnumberbox{\large\textbf{Model Number 0135}}\\[2.0ex]
    \normalsize Andúril 2 Release 2024-04-20\\[1.0ex]
    \normalsize Diagram Release 0135-25\\[2.0ex]
    Diagram Repository:\\
    https://github.com/dirtydancing/\\
    anduril-tikz-diagram-0135\\[1.0ex]
...
{
    \oneline{Aux LED Color for Voltage}\\[0.4ex]
    \voltageboxred{R-2.9,\vphantom{Voltage,Ú}}%
    \voltagebox[yellow]{Y-3.3,\vphantom{Voltage,Ú}}%
    \voltagebox[green]{G-3.5,\vphantom{Voltage,Ú}}%
    \voltagebox[cyan]{C-3.7,\vphantom{Voltage,Ú}}%
    \voltagebox[blue]{B-3.9,\vphantom{Voltage,Ú}}%
    \voltageboxpurple{P-4.1V\vphantom{Voltage,Ú}}
};
...
\node (Legend Default setting text)[
    legendconfig,
    below=0.1cm of Legend Inherited by Simple text.south west,
    anchor=north west
]
{Default setting after each factory reset};

\node (Legend Default setting picture)[
    legendconfig,
    left=0.22cm of Legend Default setting text.west,
    anchor=east
]
...
\begin{scope}[on background layer]
    \node (Strobe Modes fit)[
        ...
        (Legend Default setting text)
        (Legend Default setting picture)
    ]
    {};
\end{scope}
