...
\tikzset{
    ...
    rampcombined inside 1/.style={
        ...
        draw=yellow-1!55,
        line width=3.2pt,
        minimum width=1.6cm-3.6pt, % -3.6pt for adjacent lines
        minimum height=5.6cm-3.6pt % -3.6pt for adjacent lines
    },
    rampcombined inside 2/.style={
        rampcombined,
        draw=gray,
        very nearly transparent,
        minimum width=1.6cm-7.2pt, % -7.2pt for adjacent lines
        minimum height=5.6cm-7.2pt % -7.2pt for adjacent lines
    },
    turbocombined/.style={
        rectangle,
...
\node (Ramp Memory) at (Ramp.center) {\oneline{Memory}};
\node (Ramp Ceiling) at (Ramp.north)[below, yshift=-3.2pt]
% -3.2pt for Ramp inside 1
{\oneline{Ceiling}};
\node (Ramp Floor) at (Ramp.south)[above, yshift=3.2pt]
% +3.2pt for Ramp inside 1
{\oneline{Floor}};
...
\node (OFF right extra node ON)[
    on-extra,
    below left=0.8cm and 1.2cm of OFF right.west,
    anchor=center
]
{ON};
...
{10H} (Simple UI Ramp Config from OFF.298);
...
\node (Aux LED Color from OFF right)[
    extendedsimpleconfig,
    above right=0.9cm and 3.2cm of Lockout.center,
    anchor=south,
    align=left
]
{
    ...
    Disco \char"2192{} Rainbow\default{} \char"2192{} Voltage
};
...
]
{
    ...
    Cyan \char"2192{}\\
    Blue \char"2192{} Purple \char"2192{} White \char"2192{}\\
    Disco \char"2192{} Rainbow \char"2192{} Voltage\default{}
};
...
]
{
    ...
    \normalsize Diagram Release 0135-10\\[2.0ex]
    Diagram Repository:\\
...
]
{
    ...
    \voltageboxpurple{P-4.1V\vphantom{,Ú}}
};
