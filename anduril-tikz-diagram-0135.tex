...
]
{
    \begin{tabular}{m{0.35cm} l}
	    ...
	    \multicolumn{2}{l}{
            \thead{\mdseries\footnotesize Channel mode\\[-0.55ex]
            \mdseries\footnotesize sequence}
        }\\
 		{1} & \makecell{
		    Channel 1
		}\\
...
{
    \bfseries\Huge Andúril 2 UI\\[2.0ex]
    \tcbox[
        colframe=black,
        colback=black,
        coltext=white,
    ...
    {\bfseries\large Model Number 0135}\\[2.0ex]
    \normalsize Andúril 2 Release 2024-04-20\\[1.0ex]
    \normalsize Diagram Release 0135-03\\[2.0ex]
    Diagram Repository:\\
...
\begin{scope}
    ...
    {
        \bfseries\normalsize Aux LED Color for Voltage\\[0.75ex]
        ...
        \colorbox{purple!40}{P-4.1V\vphantom{,Ú}}% \\[0.75ex]
